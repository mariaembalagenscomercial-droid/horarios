...
# Timezone de Brasília (carregado uma vez na inicialização)
...
def esta_aberto():
    ...
    tempo = agora.hour * 60 + agora.minute  # em minutos
...
async def get_status_widget():
    ...
    Usa 302 (temporário) para que o navegador sempre consulte o status atualizado."""
...
@app.get("/health")
async def health():
    """Endpoint de health check para manter o serviço ativo (usar com cron externo)."""
    return {"status": "ok"}
